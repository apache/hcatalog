...
public class InputJobInfo implements Serializable{
   ...
   */
  public static InputJobInfo create(String dbName,
                                                  String tableName,
                                                  String filter,
                                                  String serverUri,
                                                  String serverKerberosPrincipal) {
    return new InputJobInfo(dbName,tableName,filter,serverUri,serverKerberosPrincipal);
  }

  private InputJobInfo(String dbName,
                                String tableName,
                                String filter,
                                String serverUri,
                                String serverKerberosPrincipal) {
